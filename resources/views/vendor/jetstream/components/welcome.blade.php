<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
    ...
    <div class="mt-8 text-2xl">
        Agencia digital de desempeño
    </div>

    <div class="mt-6 text-gray-500">
        Somos una agencia de marketing digital en donde usamos verdaderamente el marketing digital para mejorar los KPI de su negocio. Nuestro equipo está compuesto por especialistas altamente capacitados para ayudar a crecer su empresa, implementando estrategias basadas en herramientas de marketing digitales y optimizando su uso para el beneficio del cliente.
    </div>
</div>
