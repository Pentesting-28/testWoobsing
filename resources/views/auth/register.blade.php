        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                ...
                <div class="relative z-0 w-full group">
                    ...
                    <x-jet-input id="surname" class="block mt-2 w-full" type="text" name="surname" :value="old('surname')" required autofocus autocomplete="suename" />
                </div>
                <div class="relative z-0 w-full group">
            ...
            <div class="mt-4">
                <x-jet-label for="suename" value="{{ __('Apellido') }}" />
                <x-jet-input id="suename" class="block mt-1 w-full" type="text" name="suename" :value="old('suename')" required autofocus autocomplete="suename" />
            </div>
